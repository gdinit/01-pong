...
// WINDOW
constexpr unsigned short int	CONFIG_WIN_WIDTH = { 640 }, CONFIG_WIN_HEIGHT =
{ 480 };
const std::string		CONFIG_WINDOW_TITLE_TEXT { "Pong" };

// FPS
constexpr unsigned short int	CONFIG_DESIRED_FPS_INT { 30 };
constexpr float			CONFIG_DESIRED_FPS_FLOAT { 30.f };
//
...
// PADDLE
// based on original game paddle indent is 99.f
...
constexpr float			CONFIG_PADDLE_RIGHT_SPAWN_X { CONFIG_WIN_WIDTH -
							      50.f };
constexpr float
				CONFIG_PADDLE_RIGHT_SPAWN_Y { CONFIG_WIN_HEIGHT
				      / 2.f };
constexpr float			CONFIG_PADDLE_LEFT_SPAWN_X { 50.f };
constexpr float			CONFIG_PADDLE_LEFT_SPAWN_Y { CONFIG_WIN_HEIGHT /
							     2.f };
...
// constexpr float			CONFIG_BALL_SPEED { 0.4f };
constexpr float			CONFIG_BALL_SPEED { 0.15f };
